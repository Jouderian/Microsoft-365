---
description: Decisão de adotar Clean Code e camelCase como padrão obrigatório no repositório
---
...
## Opções Avaliadas
- Manter o formato original e estabelecer padronização apenas para scripts novos.
- Adotar PowerShell rigoroso sem aliases e unificar camelCase. (Escolhida)
