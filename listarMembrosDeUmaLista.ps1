<# 
  .SYNOPSIS
    Mostra os membros de um grupo/Lista do EntraID (via Microsoft Graph PowerShell)
  .AUTHOR
    Jouderian Nobre
  .VERSION
    01 (06/03/25) - Criacao do script
    02 (07/05/25) - Melhoria na exibicao dos dados
    03 (01/09/25) - Ajuste nos campos exibidos
    04 (08/12/25) Felipe Aquino - Migracao de AzureAD -> Microsoft.Graph
  .OUTPUT
    Lista dos membros de um grupo/Lista do EntraID (via Microsoft Graph PowerShell)
#>
